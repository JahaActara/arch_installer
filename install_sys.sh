...
# Greet and confirm install
dialog --defaultno --title "Are you sure?" --yesno \
"This is my personnel arch linux install. \n\n\
It will DESTROY EVERYTHING on one of your hard disk. \n\n\
Don't say UES if you are not sure what you're doing! \n\n\
Do you want to continue?" 15 60 || exit

# Name of your computer: field or base
...
# Choosing hard disk to install arch linux
